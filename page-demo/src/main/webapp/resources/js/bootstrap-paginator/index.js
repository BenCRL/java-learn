...
Pager.prototype.init = function(totalPages, currentPage) {
	// 初始化table
...
Pager.prototype.initTable = function(totalPages, currentPage) {// table初始化
	var that = this;
...
Pager.prototype.initSearchQuery = function() {// 查询功能初始化
	var that = this;
	// 绑定查询按钮点击事件
...
Pager.prototype.initPageChange = function() {// 切换页面显示条数功能初始化
	var that = this;
...
Pager.prototype.initSort = function() {// 字段排序功能初始化
	var that = this;
...
Pager.prototype.initSortStyle = function() {// 排序图标效果初始化
	var that = this;
...
Pager.prototype.initGoToThePage = function(pageCount) {// 跳转至指定页面
	var that = this;
