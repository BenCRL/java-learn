	...
	<ul>
		<c:if test="${page.pageCount>1}">
			<c:if test="${page.pageNum==1}">
				...
				<li>
					<a href="javascript:doSubmit('${page.pageNum+1}');">下一頁</a>
				</li>
				<li class="last">
					<a href="javascript:doSubmit('${page.pageCount}');">末頁</a>
				</li>
			</c:if>
			<c:if test="${page.pageNum>1 and page.pageNum<page.pageCount}">
				<li class="first">
					<a href="javascript:doSubmit('1');">首頁</a>
				</li>
				<li>
					<a href="javascript:doSubmit('${page.pageNum-1 }');">上一頁</a>
				</li>
				<li>
					<a href="javascript:doSubmit('${page.pageNum+1 }');">下一頁</a>
				</li>
